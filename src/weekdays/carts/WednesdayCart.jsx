...
export const WednesdayCart = () => {
  return (
    <div className="workout-card">
        ...
        <p> Full Crunch machine (3 sets x 8-12 reps per leg) </p>
        ...
        <img src='https://www.inspireusafoundation.org/wp-content/uploads/2021/10/single-arm-dumbbell-row.gif' alt='v-taper'/>
        <p> V-Taper (3 sets x 8-12 reps) </p>
    </div>
  )
}
